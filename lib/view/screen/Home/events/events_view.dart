...
class EventsView extends GetView<EventsController> {
  ...
  Widget _exhibitionEventsTab() => Obx(() {
    if (controller.exhibitionEvents.isEmpty)
      return const EmptyWidget(message: 'لا توجد فعاليات');
    return ListView.builder(
      ...
      itemBuilder: (_, i) => EventCard(
        ...
        showFavorite: true,
        onFavorite: () =>
            controller.toggleFavorite(controller.exhibitionEvents[i]),
      ),
    );
  });
}
