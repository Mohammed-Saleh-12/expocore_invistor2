...
class CreateEventView extends GetView<EventsController> {
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: sel
                        ...
                        : null,
                    color: sel ? null : (isDark ? AppColors.darkCard : AppColors.lightCard),
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                      color: sel ? Colors.transparent : opt.color.withOpacity(0.3),
                      width: 1.5,
                    ),
                    boxShadow: sel
                        ? [BoxShadow(color: opt.color.withOpacity(0.35), blurRadius: 12, offset: const Offset(0, 4))]
                        : null,
                  ),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Icon(opt.icon, size: 22, color: sel ? Colors.white : opt.color),
                      const SizedBox(height: 6),
                      Text(
                        opt.label,
                        style: TextStyle(
  ...
  // ── Free-limited info banner ──────────────────────────────
  Widget _freeLimitedBanner(bool isDark) => Container(
        padding: const EdgeInsets.all(14),
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [AppColors.darkSecondary.withOpacity(0.12), AppColors.darkSecondary.withOpacity(0.05)],
          ),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: AppColors.darkSecondary.withOpacity(0.35)),
        ),
        child: Row(
          children: [
            Container(
            ...
            Row(
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: images.isNotEmpty ? AppColors.darkPrimary : AppColors.grey,
                    fontWeight: FontWeight.w600,
                  ),
                ),
                const Spacer(),
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    // Add more cell
                    if (canAdd) _AddMoreCell(isDark: isDark, onTap: controller.pickImages),
                  ],
                ),
              )
            else
...
class _ImageThumb extends StatelessWidget {
  ...
  final int    index;
  final bool   isDark;
  const _ImageThumb({required this.file, required this.index, required this.isDark});
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.add_rounded,
                color: AppColors.darkPrimary.withOpacity(0.7), size: 28),
