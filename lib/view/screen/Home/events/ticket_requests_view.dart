          ...
          children: [
            ...
            Expanded(
              child: Obx(() {
                ...
                final rejected =
                    all.where((r) => r.status == 'rejected').toList();
                return TabBarView(
                  children: [
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () =>
                        ctrl.rejectTicketRequest(request),
                ...
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () =>
                        ctrl.approveTicketRequest(request),
...
class _QrCodeWidget extends StatelessWidget {
  ...
  const _QrCodeWidget(
      {required this.ticketNumber, required this.qrData});
...
class _QrPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final pos in cornerPositions) {
      // Outer square
      canvas.drawRect(
        Rect.fromLTWH(pos.dx * cellSize, pos.dy * cellSize,
    ...
    final dataCells = [
      const Offset(4, 0), const Offset(5, 1), const Offset(3, 2),
      const Offset(6, 2), const Offset(7, 2), const Offset(4, 3),
      const Offset(0, 4), const Offset(2, 4), const Offset(5, 4),
      const Offset(8, 4), const Offset(1, 5), const Offset(3, 5),
      const Offset(7, 6), const Offset(4, 7), const Offset(6, 7),
      const Offset(1, 8), const Offset(3, 8), const Offset(5, 8),
    ];
    for (final cell in dataCells) {
      canvas.drawRect(
        Rect.fromLTWH(
            cell.dx * cellSize, cell.dy * cellSize, cellSize, cellSize),
        paint,
      );
    }
  }
