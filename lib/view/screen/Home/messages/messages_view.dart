      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          Container(
            ...
            child: const Center(child: Text('EC', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w900))),
          ),
          const SizedBox(width: 10),
          const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('إدارة المعرض', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
            Text('متاح الآن', style: TextStyle(fontSize: 11, color: AppColors.success)),
          ]),
        ]),
        actions: [
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              const PopupMenuItem(value: 'booking', child: Text('استفسار عن حجز')),
      ...
      body: Column(children: [
        Expanded(child: Obx(() => ListView.builder(
          ...
          itemBuilder: (_, i) {
            ...
            return _Bubble(isMe: m.isMe, text: m.text, time: m.time, isRead: m.isRead);
          },
        ))),
...
class _Bubble extends StatelessWidget {
  ...
  const _Bubble({required this.isMe, required this.text, required this.time, required this.isRead});
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isMe ? null : (isDark ? AppColors.darkCard : AppColors.lightCard),
        ...
        child: Column(crossAxisAlignment: isMe ? CrossAxisAlignment.start : CrossAxisAlignment.end, children: [
          ...
          Row(mainAxisSize: MainAxisSize.min, children: [
            Text(time, style: TextStyle(fontSize: 10, color: isMe ? Colors.white70 : AppColors.grey)),
            if (isMe) ...[const SizedBox(width: 4), Icon(isRead ? Icons.done_all : Icons.done, size: 12, color: Colors.white70)],
          ]),
        ]),
      ),
    );
