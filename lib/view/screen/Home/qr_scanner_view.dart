import 'package:expocore_invistor2/controller/Home/qr_scanner_controller.dart';
...
class _CircleBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        color: active ? AppColors.darkAccent.withOpacity(0.85) : Colors.black45,
      ),
