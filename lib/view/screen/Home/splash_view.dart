...
class _SplashViewState extends State<SplashView> with TickerProviderStateMixin {
          ...
          child: Stack(
            children: [
              ...
              _buildGlowBlob(
                ...
                left: -70,
                blobSize: 250,
                color: AppColors.darkPrimary.withOpacity(0.16),
              ),
              _buildGlowBlob(
                bottom: size.height * 0.06,
                right: -50,
                blobSize: 210,
                color: AppColors.darkSecondary.withOpacity(0.13),
              ),
              _buildGlowBlob(
  ...
  Widget _buildParticles(Size size) => AnimatedBuilder(
    ...
    builder: (_, __) =>
        CustomPaint(size: size, painter: _ParticlePainter(_particleCtrl.value)),
  );
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  ...
                  BoxShadow(
                    color: AppColors.darkSecondary.withOpacity(0.25),
                    blurRadius: 60,
                    spreadRadius: 2,
                  ),
                ],
  ...
  Widget _buildLoader() =>
      FadeTransition(opacity: _textFade, child: const _PulsingLoader());
}
...
class _ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    for (final p in _particles) {
      ...
      final alpha = (0.25 + sin((progress + p[3]) * pi) * 0.25).clamp(
        0.05,
        0.55,
      );
