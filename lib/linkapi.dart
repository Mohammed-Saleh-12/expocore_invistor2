...
class AppLink {
  ...
  static String get investorVisitorMessages       => '$server/investor/visitor-messages';
  static String visitorConversationDetail(int id) => '$server/investor/visitor-messages/$id';
  static String sendVisitorMessage(int id)        => '$server/investor/visitor-messages/$id/send';
  ...
  static String get markAllNotificationsRead      => '$server/investor/notifications/read-all';
