...
class WebBoothsPage extends StatelessWidget {
  ...
  Widget _empty() => Container(
        ...
        child: Column(
          children: [
            Icon(Icons.grid_off_rounded, size: 56, color: AppColors.grey.withOpacity(0.5)),
...
class _BoothCard extends StatelessWidget {
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.storefront_rounded, color: AppColors.darkPrimary, size: 24),
              ),
              ...
              if (_approved)
                Expanded(
                  child: _btn(
                    label: 'التقرير',
                    filled: false,
                    onTap: () => WebNavController.to.openReport(c.buildBoothReport(booth)),
                  ),
                ),
            ],
          ),
  ...
  Widget _btn({required String label, required bool filled, required VoidCallback onTap}) =>
      GestureDetector(
        onTap: onTap,
        child: Container(
