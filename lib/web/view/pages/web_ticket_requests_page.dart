        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${'ticket_requests_title'.tr}: ${event.name}',
                style: TextStyle(
                  color: WebTheme.text,
                  fontSize: 24,
              ...
              Obx(() {
                ...
                return Column(
                  children: all
                      .map((r) => _RequestCard(req: r, c: c, isPaid: isPaid))
                      .toList(),
                );
              }),
            ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // QR (approved)
          if (req.status == 'approved' && req.qrCodeData != null) ...[
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      Text(
                        req.ticketNumber ?? req.qrCodeData!,
                        style: TextStyle(
                          color: AppColors.success,
                          fontSize: 13,
                          fontWeight: FontWeight.w700,
