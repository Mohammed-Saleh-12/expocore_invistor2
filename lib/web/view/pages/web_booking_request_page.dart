...
class WebBookingRequestPage extends StatelessWidget {
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${booth.location} • ${booth.area.toStringAsFixed(0)} م²',
          ...
          Column(
            ...
            children: [
              ...
              Text(
                booth.pricingType == 'daily' ? 'سعر يومي' : 'سعر كامل المعرض',
          ...
          child: Row(
            ...
            children: [
              Icon(
                icon,
                size: 16,
                color: sel ? Colors.white : WebTheme.primary,
              ),
      ...
      child: Column(
        ...
        children: [
          ...
          _costRow(
            ...
            '${(booth?.pricingType == 'daily' ? (booth?.price ?? 0) * dur : (booth?.price ?? 0)).toInt()} ر.س',
          ),
  ...
  Widget _submitButton(BookingController c) => Obx(
    () => GestureDetector(
      onTap: c.isSubmitting.value ||
              c.isCheckingRequest.value ||
              c.hasPendingRequest
          ? null
          : c.submitBooking,
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            gradient: c.isSubmitting.value ||
                c.isCheckingRequest.value ||
                c.hasPendingRequest
              ? null
              : AppColors.favoriteGradient,
            color: c.isSubmitting.value ||
                c.isCheckingRequest.value ||
                c.hasPendingRequest
        ...
        child: c.isSubmitting.value
            ...
            : Text(
              c.hasRejectedRequest ? 'إرسال طلب جديد' : 'booking_submit'.tr,
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                  fontWeight: FontWeight.w700,
  ...
  Widget _requestStatusBanner(BookingController c) => Obx(() {
    if (c.isCheckingRequest.value) return const SizedBox.shrink();
    final pending = c.hasPendingRequest;
    final rejected = c.hasRejectedRequest;
