                  ...
                  children: [
                    ...
                    _card('الإشعارات', [
                      Obx(() => _switchTile(
                            ...
                            onChanged: (v) =>
                                c.notificationsEnabled.value = v,
                          )),
                      Obx(() => _switchTile(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(title,
                  style:
                      TextStyle(color: WebTheme.text, fontSize: 14)),
            ),
            Switch(
              value: value,
              onChanged: onChanged,
          ...
          Obx(() {
            ...
            return Column(
              children: [
                ...
                _field('Facebook', p.facebookCtrl, Icons.facebook,
                    editing),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                prefixIcon:
                    Icon(icon, color: AppColors.grey, size: 19),
                filled: true,
                fillColor:
                    editing ? WebTheme.surfaceAlt : WebTheme.topbar,
