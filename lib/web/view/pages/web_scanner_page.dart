        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('مسح QR / باركود', style: TextStyle(color: WebTheme.text, fontSize: 24, fontWeight: FontWeight.w900)),
              const SizedBox(height: 6),
              Text('وجّه الكاميرا نحو الرمز للمسح', style: TextStyle(color: AppColors.grey, fontSize: 14)),
              const SizedBox(height: 20),
              ClipRRect(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('تعذّر الوصول للكاميرا', style: TextStyle(color: WebTheme.text, fontSize: 15, fontWeight: FontWeight.w700)),
                                const SizedBox(height: 6),
