...
// ════════════════════════════════════════════════════════════
//  WebForgotPasswordOtpPage
//  الخطوة 2: إدخال رمز OTP المُرسَل إلى البريد الإلكتروني
// ════════════════════════════════════════════════════════════
class WebForgotPasswordOtpPage extends StatelessWidget {
  const WebForgotPasswordOtpPage({super.key});
              ...
              child: SingleChildScrollView(
                ...
                child: ConstrainedBox(
                  ...
                  child: WebFadeIn(
                    ...
                    child: GetBuilder<_WebForgotOtpController>(
                      init: _WebForgotOtpController(),
                      global: false,
                      builder: (ctrl) => _OtpForm(ctrl: ctrl, fpCtrl: fpCtrl),
                    ),
                  ),
                ),
              ),
...
class _OtpForm extends StatelessWidget {
  final _WebForgotOtpController ctrl;
  final ForgotPasswordController fpCtrl;
  const _OtpForm({required this.ctrl, required this.fpCtrl});
      ...
      children: [
        ...
        RichText(
          ...
          text: TextSpan(
            ...
            children: [
              TextSpan(text: 'fotp_hint'.tr),
              const TextSpan(text: ' '),
              TextSpan(
                text: fpCtrl.savedEmail.value,
                style: TextStyle(
        ...
        Obx(() {
          ...
          return SizedBox(
            ...
            child: _GradientButton(
              loading: loading,
              disabled: !ready,
              onTap: () => fpCtrl.verifyOtp(ctrl.otp.value),
