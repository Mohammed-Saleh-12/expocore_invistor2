...
import 'pages/web_exhibitions_page.dart';
import 'pages/web_booths_page.dart';
import 'pages/web_events_page.dart';
import 'pages/web_reports_page.dart';
import 'pages/web_messages_page.dart';
import 'pages/web_favorites_page.dart';
import 'pages/web_settings_page.dart';
import 'pages/web_sponsorships_page.dart';
import 'pages/web_detail_view.dart';

// ════════════════════════════════════════════════════════════
//  WebApp  —  جذر نسخة الويب
//  يلفّ المحتوى بـ Navigator خاص حتى تعمل الـ dropdowns
//  وdate pickers والـ dialogs (تحتاج Navigator أب)
// ════════════════════════════════════════════════════════════
...
class _WebHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      WebTheme.isDark.value; // إعادة بناء كامل الواجهة عند تبديل الثيم
      return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                Obx(() => WebTopbar(title: nav.currentTitle)),
                Expanded(
                  child: Obx(() {
                    // إذا كانت هناك صفحة داخلية مفتوحة، اعرضها
